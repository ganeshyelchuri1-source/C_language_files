...
if money<down_payment :
    print("it is not possible to pay the down payment in thriry six years")
else :
    low=0
    high=1
    steps=1
    ...
    while True:
        ...
        for i in range(1,months+1):
            ...
            if i%6==0 :
                salary+=salary*semi_annual_return
        #here abs acts like modulus if it passes -2===> passes 2
        if abs(money-down_payment)<=100:
            ...
            high=rate
print(f"enter savings rate {best_rate,4}")
